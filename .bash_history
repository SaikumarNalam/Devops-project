...
git remote add origin https://github.com/SaikumarNalam/Devops-project.git
...
clear
unzip devops-pipeline.zip
cd devops-pipeline
git init && git add . && git commit -m "Initial DevOps pipeline"
...
git commit -m "initial commit"
git branch -M main
git remote set-url origin https://github.com/SaikumarNalam/Devops-project.git
git push -u origin main
clear
ll
clear
...
git rm -r --cached .
git add .
git commit -m "cleanup: remove unwanted files"
git push
clear
mkdir -p devops-pipeline/{app,docker,terraform,.github/workflows}
cd devops-pipeline
vi app/app.py
...
du -sh *
cat app.py 
root@ip-172-31-45-41:~/devops-pipeline/app# du -sh *
4.0K    app.py
4.0K    requirements.txt
root@ip-172-31-45-41:~/devops-pipeline/app#
wc -l app.py
clear
wc -l app.py
